...
function initSelectors(){
 ...
 MAIN.createRelatedSelector(); 
 MAIN.createRelatedSelector(document.querySelector('#selectlocation') );
 
 //countries
 MAIN.createRelatedSelector
     ( document.querySelector('#selectlocation')           // from select element
      ,document.querySelector('#newid')      // to select element
      ,{                                               // values object 
        India: ['China','Japan','North Korea','South Korea','India','Malaysia','Uzbekistan'],
